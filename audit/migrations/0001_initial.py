    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cooperative', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='audit_logs', to='tenants.cooperative')),
            ],
            options={
                'ordering': ['-created_at', '-id'],
                'indexes': [models.Index(fields=['cooperative', '-created_at'], name='audit_audit_coopera_19e50a_idx')],
            },
        ),
    ]
